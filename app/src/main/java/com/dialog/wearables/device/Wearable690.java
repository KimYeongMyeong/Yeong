...
import com.dialog.wearables.sensor.chip.ICP10100;
import com.dialog.wearables.sensor.chip.ICM20789;
import com.dialog.wearables.sensor.chip.LSM6DS3;

import min3d.core.Object3dContainer;

public class Wearable690 extends IotDeviceSpec {

    public static final int ICON = R.drawable.icon_690;
    ...
    protected ICP10100 environmental;
//    protected BME280 environmental;
    protected ICM20789 imu;
//    protected LSM6DS3 imu;
    ...
    public Wearable690(IotSensorsDevice device) {
        super(device);
        environmental = new ICP10100();
...
//        imu = new LSM6DS3();
        ...
        basicSettings.setProcessCallback(new IotDeviceSettings.ProcessCallback() {
            ...
            public void onProcess() {
                ...
                boolean sfl = Wearable690.this.device.sflEnabled && basicSettings.sflEnabled;

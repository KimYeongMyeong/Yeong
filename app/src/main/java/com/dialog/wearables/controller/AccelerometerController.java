...
//                }
                switch (i) {
                    case 0:
//                        eulerX = axisArr;
                        GlobalVar.accArr.pushAccDataX(axisArr);
//                        GlobalVar.gyroEulerArr.pushEulerDataX(axisArr);
                        break;
                    case 1:
                        /*eulerY = axisArr;*/
                        GlobalVar.accArr.pushAccDataY(axisArr);
                        break;
                    case 2:
                        /*eulerZ = axisArr;*/
                        GlobalVar.accArr.pushAccDataZ(axisArr);
                        break;
                }

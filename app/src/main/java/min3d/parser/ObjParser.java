...
public class ObjParser extends AParser implements IParser {
	 ...
	 * @param resourceID
	 */
	public ObjParser(Resources resources, int resourceID, boolean generateMipMap) {
		super(resources, resourceID, generateMipMap);
		packageID = resources.getResourcePackageName(resourceID);
	}
	...
	private void readMaterialLib(String libID) {
		...
		InputStream fileIn = resources.openRawResource(resources.getIdentifier(libIDSbuf.toString(), "raw", packageID));

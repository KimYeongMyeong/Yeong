...
public class TextureList  
{
	...
	{
		return addById($textureId, Shared.textureManager());
	}

	public TextureVo addById(String $textureId, TextureManager $textureManager)
	{
		if (! $textureManager.contains($textureId)) {
